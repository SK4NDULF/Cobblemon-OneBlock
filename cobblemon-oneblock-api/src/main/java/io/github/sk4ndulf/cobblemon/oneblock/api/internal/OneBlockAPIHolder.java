package io.github.sk4ndulf.cobblemon.oneblock.api.internal;
 ...
 *
 * <p><b>Internal API — do not call from addon code.</b> Only the {@code cobblemon_oneblock} core mod
    ...
    public static OneBlockAPI get() {
        ...
        if (api == null) {
            throw new IllegalStateException(
                    "OneBlockAPI is not available yet. The cobblemon_oneblock core mod has not finished initializing.");
        }
        return api;
    }
