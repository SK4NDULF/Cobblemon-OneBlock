package io.github.sk4ndulf.oneblock.core.cobblemon
...
import io.github.sk4ndulf.oneblock.core.trigger.EventSpawning
...
class LegendaryEncounterEvent : TriggerEventType {
    ...
    override fun id(): ResourceLocation = ResourceLocation.fromNamespaceAndPath("oneblock", "legendary_encounter")

    override fun displayName(): String = ServerLang.raw("oneblock.event.type.legendary")
        ...
        private fun spawn(context: TriggerEventContext): Boolean {
            ...
            for (player in context.participants()) {
                player.sendSystemMessage(
                    ServerLang.msg("oneblock.event.legendary_appeared", entity.pokemon.species.name)
