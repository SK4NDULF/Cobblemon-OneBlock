package io.github.sk4ndulf.cobblemon.oneblock.core

import io.github.sk4ndulf.cobblemon.oneblock.api.internal.OneBlockAPIHolder
import io.github.sk4ndulf.cobblemon.oneblock.core.api.EventBusImpl
import io.github.sk4ndulf.cobblemon.oneblock.core.api.OneBlockAPIImpl
import io.github.sk4ndulf.cobblemon.oneblock.core.command.ObCommands
...
object OneBlockCore : ModInitializer {
    ...
    const val MOD_ID = "cobblemon_oneblock"
        ...
        ServerPlayConnectionEvents.JOIN.register { handler, _, server ->
            ...
            if (!configManager.mainConfig.setupCompleted && player.hasPermissions(4)) {
                player.sendSystemMessage(
                    ServerLang.msg("cobblemon_oneblock.welcome.op")
    ...
    private fun rescueStrandedPlayer(player: ServerPlayer) {
        ...
        HubManager.sendToHub(player)
        player.sendSystemMessage(
            ServerLang.msg("cobblemon_oneblock.island.stranded").withStyle(ChatFormatting.GOLD),
        )
    }
