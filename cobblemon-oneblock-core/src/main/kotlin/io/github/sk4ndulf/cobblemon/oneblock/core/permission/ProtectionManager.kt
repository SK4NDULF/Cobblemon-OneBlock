 ...
 *  - Admins with op level >= 2 bypass island rules (`cobblemon_oneblock.admin.bypass`).
 *
...
object ProtectionManager {
    ...
    enum class Denial(val langKey: String) {
        HUB("cobblemon_oneblock.hub.no_modify"),
        FOREIGN_ISLAND("cobblemon_oneblock.protect.no_permission"),
        OUTSIDE_BORDER("cobblemon_oneblock.protect.outside_border"),
        VOID_BUFFER("cobblemon_oneblock.protect.void_buffer"),
    }
