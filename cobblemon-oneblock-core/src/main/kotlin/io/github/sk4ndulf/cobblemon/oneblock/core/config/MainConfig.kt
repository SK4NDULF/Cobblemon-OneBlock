...
data class MainConfig(
    ...
    /** Maximum biome regions per island. Wizard question 4. Range 1..50. */
    val maxBiomeRegions: Int = 10,

    /** Cobblemon spawn intensity multiplier. Wizard question 5. Range 0.1..5.0. */
    val cobblemonSpawnMultiplier: Double = 1.0,

    /** Whether the server is public. Wizard question 6. */
    val serverPublic: Boolean = true,

    /** Whether admins may build inside the hub radius. Wizard question 7. */
