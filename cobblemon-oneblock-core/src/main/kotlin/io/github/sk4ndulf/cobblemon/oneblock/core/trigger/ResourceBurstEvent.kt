...
class ResourceBurstEvent : TriggerEventType {
    ...
    override fun id(): ResourceLocation = ResourceLocation.fromNamespaceAndPath("cobblemon_oneblock", "resource_burst")

    override fun displayName(): String = ServerLang.raw("cobblemon_oneblock.event.type.resource_burst")
